...
if __name__ == '__main__':
    # Apply to CSV
    format_votes_csv('../../data_raw/votes_raw.csv', '../../data_enhanced/votes_ReasonClassificationPrep.csv')

    # Apply to JSON
    format_votes_json('../../data_raw/votes_raw.json', '../../data_enhanced/votes_ReasonClassificationPrep.json')
